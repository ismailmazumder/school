...
while True:
    try:
        url = f'https://bafsemc.rapid.com.bd/Views/profile/profile_staff_single.php?type=Teacher&id={count}'
        ...
        pic_path = "https://bafsemc.rapid.com.bd/"+remove_prefix(str(match.group(1)), '../../')
